                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row" style="margin-bottom: 0px;">
                                                            <div class="col-lg-12">
                                                                <label>Dokumen Selesai</label>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                @if ($pengabdian->dokumen_selesai)
                                                                <a href="{{ url($pengabdian->dokumen_selesai) }}" download>
                                                        ...
                                                        <form class="form-horizontal" action="{{ url('admin/pengabdian-riwayat/update-status', $pengabdian->id) }}" method="post">
                                                            @csrf
                                                            @method('PUT')
