                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row" style="margin-bottom: 0px;">
                                                            ...
                                                            <div class="col-lg-6">
                                                                @if ($penelitian->dokumen_aktif)
                                                                <a href="{{ url($penelitian->dokumen_aktif) }}" download>
                                                        ...
                                                        <form class="form-horizontal" action="{{ url('admin/penelitian-selesai/update-status', $penelitian->id) }}" method="post">
                                                            @csrf
                                                            @method('PUT')
