                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <!-- Modify your form to use the 'POST' method and include the 'enctype' attribute for file uploads. -->
                                                        <div class="form-group row" style="margin-bottom: 0px;">
                                                            <div class="col-lg-12">
                                                                <label>Dokumen Kemajuan Proposal</label>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <form action="{{ route('penelitian.update', ['id' => $penelitian->id]) }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf <!-- CSRF token for security -->
                                                                    @method('PUT') <!-- Specify the HTTP method as PUT for data update -->
                                                                    <div class="mb-3">
                                                                        <input type="file" class="form-control" name="dokumen_aktif" accept="application/pdf">
                                                                    </div>
